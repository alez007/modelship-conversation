"""Constants for the Modelship Conversation integration."""
...
DEFAULT_CONVERSATION_NAME = "Modelship Conversation"
DEFAULT_AI_TASK_NAME = "Modelship AI Task"
DEFAULT_STT_NAME = "Modelship STT"
DEFAULT_TTS_NAME = "Modelship TTS"
DEFAULT_NAME = "Modelship Conversation"

# Connection. Modelship is a self-hosted OpenAI-compatible server, so the base
# URL is required and the API key is optional (a dummy key is sent if blank).
CONF_BASE_URL = "base_url"
DEFAULT_BASE_URL = "http://homeassistant:8000/v1"
DEFAULT_API_KEY = "sk-noauth"
