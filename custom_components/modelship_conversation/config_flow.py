"""Config flow for Modelship Conversation integration."""
...
STEP_USER_DATA_SCHEMA = vol.Schema(
    {
        ...
        # Modelship needs no auth; leave blank to use a dummy key.
    ...
    async def _get_location_data(self) -> dict[str, str]:
        ...
        if zone_home is not None:
            client = openai.AsyncOpenAI(
                ...
                api_key=self._get_entry().data.get(CONF_API_KEY) or DEFAULT_API_KEY,
